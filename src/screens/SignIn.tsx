...
export function SignIn({ onDone }: { onDone: () => void; onCreate?: () => void }) {
  ...
  return (
    <div className="relative flex h-full w-full flex-col overflow-hidden">
      ...
      <LightRays raysOrigin="top-center" raysColor="#23FFED" raysSpeed={0.7} lightSpread={0.9} rayLength={1.9} followMouse={false} style={{ opacity: isLight ? 0.14 : "var(--rays-op, 0.7)" }} />
