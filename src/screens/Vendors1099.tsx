    ...
    <div className="flex h-full w-full flex-col bg-bg">
      ...
      <motion.div variants={stagger} initial="hidden" animate="show" className="no-scrollbar flex-1 overflow-y-auto px-5 pb-28 pt-4">
        ...
        <motion.div variants={item}>
          <Explainer title="What is 1099 & vendors?">The IRS needs a 1099-NEC for every contractor you pay $600+ in a year. Zeva tallies each vendor's payments, flags who crosses the threshold, collects their W-9, and pre-fills the forms — so tax time is a click, not a scramble.</Explainer>
        </motion.div>
