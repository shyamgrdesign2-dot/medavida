...
import { Toggle, Explainer } from "@/components/ui";
    ...
    <div className="flex h-full w-full flex-col bg-bg">
      ...
      <motion.div variants={stagger} initial="hidden" animate="show" className="no-scrollbar flex-1 overflow-y-auto px-5 pb-10 pt-4">
        ...
        <motion.div variants={item}>
          <Explainer title="What are reserves?">Reserves are set-aside pots inside your balance — for tax, payroll and supplies. With auto-split on, every dollar you collect is divided across them by the % below, so the money is ready before the bill is. Turn it off and everything lands in Operating; you move funds yourself. It's tracking only — no separate bank accounts.</Explainer>
        </motion.div>
