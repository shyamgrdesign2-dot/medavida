...
const MEMBERS: Member[] = [
  { name: "Dr. Shyam GR", initials: "SG", role: "Owner", roleTone: "accent", can: "Full access · collect, pay, approve, manage cards", card: "5528", you: true },
  { name: "Jon Alvarez", initials: "JA", role: "Office manager", roleTone: "neutral", can: "Approve & pay bills · collect payments", card: "8802" },
